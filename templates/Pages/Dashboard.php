...
<div class="easy-ai-blogger-dashboard">
    ...
    <form id="easy-ai-blogger-multistep-form" class="easy-ai-blogger-form">
        <div id="eab-step-1" class="eab-step">
            <h2 class="easy-ai-blogger-step-title">Step 1: Generate Blog Content</h2>
            <label for="eab-sample-text" class="easy-ai-blogger-label">Sample Text:</label>
            <textarea id="eab-sample-text" name="sample_text" class="easy-ai-blogger-textarea"></textarea>
            <button type="button" id="eab-generate-content" class="easy-ai-blogger-btn">Write Complete Blog Text with AI</button>
            <div id="eab-generated-content" class="easy-ai-blogger-generated"></div>
            <div class="easy-ai-blogger-nav">
                <button type="button" class="eab-next-step easy-ai-blogger-btn">Next</button>
        ...
        <div id="eab-step-2" class="eab-step" style="display:none;">
            ...
            <div class="easy-ai-blogger-nav">
                <button type="button" class="eab-prev-step easy-ai-blogger-btn">Previous</button>
                <button type="button" class="eab-next-step easy-ai-blogger-btn">Next</button>
                <button type="button" class="easy-ai-blogger-skip" data-skip="3">Skip to Images</button>
                <button type="button" class="easy-ai-blogger-skip" data-skip="4">Skip to Review</button>
            </div>
